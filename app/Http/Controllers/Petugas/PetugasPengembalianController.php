...
class PetugasPengembalianController extends Controller
{
      ...
      public function index()
      {
          ...
          return view('Petugas.Components.pengembalian', compact('peminjaman', 'instansi', 'anggota'));
      }
      ...
      public function checkAnggota(Request $request)
      {
          ...
          return redirect()->route('petugaspengembalian.create', [
      ...
      public function create($id_anggota, Request $request)
      {
          ...
          return view('petugas.Components.buat-pengembalian', compact('peminjaman', 'anggota', 'instansi'));
      }
      ...
      public function update(Request $request, $id_peminjaman)
      {
          ...
          return redirect()->route('petugaspengembalian')->with('success', 'Data pengembalian berhasil diperbarui.');
      }
