...
class PetugasDataBukuController extends Controller
{
      //index
      public function index(){
        ...
        $buku = Buku::all();
        return view("Petugas.Components.data-buku", compact('instansi', 'jenis', 'buku'));
    }
    ...
    public function update(Request $request, $id_buku)
    {
        ...
        if ($buku->save()) {
            return redirect()->route('petugasdatabuku')->with('success', 'Buku berhasil diperbarui');
        } else {
            return redirect()->route('petugasdatabuku')->with('error', 'Terjadi kesalahan saat memperbarui buku.');
        }
    }
