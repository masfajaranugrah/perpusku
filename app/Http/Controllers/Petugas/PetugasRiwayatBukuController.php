...
class PetugasRiwayatBukuController extends Controller
{
...
$datariwayat = Peminjaman::select('buku.judul', \DB::raw('COUNT(*) AS total_peminjaman'))
        ...
        ->get();
        return view("Petugas.Components.riwayat-buku", compact('instansi', 'jenisRataRata', 'data_per_bulan', 'datariwayat'));
    }
}
