...
class AnggotaController extends Controller
{
    ...
    public function index(){
        ...
        $anggota = Anggota::all();
        return view("Admin.Components.anggota", compact('instansi', 'anggota'));
    }
    ...
    public function riwayat($id_anggota) {
        ...
        return view("Admin.Components.riwayat-peminjaman-buku", compact('instansi', 'anggota', 'peminjaman'));
    }
    ...
    public function show($id_anggota)
    {
        ...
        if ($anggota) {
            ...
            return view('Admin.Components.riwayat-peminjaman-buku', compact('anggota', 'peminjaman'));
        } else {
            // Handle the case when the member is not found
            return redirect()->back()->with('error', 'Data anggota tidak ditemukan.');
        }
