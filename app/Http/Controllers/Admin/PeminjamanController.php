...
class PeminjamanController extends Controller
{
   ...
   public function index()
   {
       ...
       return view('admin.Components.peminjaman', compact('peminjamans', 'tanggal', 'instansi', 'anggota'));
   }
 ...
 public function create($id_anggota, Request $request)
{
    ...
    return view('admin.Components.buat-pinjaman', compact('anggota', 'source', 'referral', 'instansi', 'buku'));
}
   ...
   public function store(Request $request)
   {
       ...
       if (!$idAnggota || empty($idBukuList)) {
        ...
        return redirect()->route('peminjaman')->with('error', 'ID anggota dan ID Buku tidak di temukan. Silahkan Coba  lagi');
       }

       // Check if member exists
       $anggota = Anggota::where('id_anggota', $idAnggota)->first();
       if (!$anggota) {
        return redirect()->route('peminjaman.create')->with('gagal', 'ID anggota tidak di temukan.');
    }
       ...
       foreach ($idBukuList as $idBuku) {
           ...
           if ($buku) {
               Peminjaman::create([
                ...
                return redirect()->route('peminjaman')->with('success', 'Data jenis  berhasil tambahkan.');
