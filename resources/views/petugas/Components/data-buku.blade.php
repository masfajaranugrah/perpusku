                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="card-content">
                                                            <div class="card-body">
                                                                <form class="form form-vertical" method="post" action="{{ route('petugasbuku.store') }}" enctype="multipart/form-data">
                                                                    @csrf
                                                                    <div class="form-body">
                                                                        <div class="row">
                                                                            <div class="col-12">
                                                                                <div class="form-group has-icon-left">
                                                                                    ...
                                                                                    <div class="position-relative">
                                                                                        <input type="text" name="kode_buku" class="form-control" placeholder="Belajar Coding" id="judul" required>
                                                                                ...
                                                                                <div class="form-group has-icon-left">
                                                                                    ...
                                                                                    <div class="position-relative">
                                                                                        <input type="text" name="judul" class="form-control" placeholder="Belajar Coding" id="judul" required>
                                                                                        <div class="form-control-icon">
                                                                                            <i class="bi bi-book"></i>
                                                                                        </div>
                                                                                        @error('judul')
                                                ...
                                                <td>
                                                    ...
                                                    <button type="button" class="btn btn-outline-warning"
                                                        ...
                                                        data-bs-target="#warning-{{$data->id_buku}}"><i
                                                            ...
                                                            <form id="delete-form-{{ $data->id_buku }}" action="{{ route('petugasbuku.destroy', $data->id_buku) }}"  method="POST" style="display: inline;">
                                                                @csrf
                                                                @method('DELETE')
                                                        ...
                                                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <div class="card-content">
                                                                        <div class="card-body">
                                                                            <form class="form form-vertical" method="POST" action="{{ route('petugasbuku.update', $data->id_buku) }}" enctype="multipart/form-data">
                                                                                @csrf
                                                                                <div class="form-body">
                                                                                    <div class="row">
