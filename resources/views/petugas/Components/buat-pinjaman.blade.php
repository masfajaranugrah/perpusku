                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form id="peminjamanForm" method="POST" action="{{ route('petugaspeminjaman.store') }}">
                                    @csrf
                                    <input type="hidden" name="id_anggota" value="{{ $anggota->id_anggota }}">
                                    
                                    <!-- Input untuk memasukkan ID Buku -->
                                    <div class="row">
                                        <div class="col-sm-10 mb-1">
                                            <div class="input-group input-group-lg">
                                                ...
                                                <select name="id_buku" id="inputBookId" class="form-control">
                                                    ...
                                                    @foreach ($buku as $a)
                                                        <option value="{{ $a->id_buku }}">{{ $a->id_buku }} - {{ $a->judul }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                    ...
                                    <!-- List ID Buku yang akan dipinjam -->
                                    <div class="row">
                                        <div class="col-md-10">
