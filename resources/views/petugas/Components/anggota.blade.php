                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="card-content">
                                                            <div class="card-body">
                                                                <form class="form form-vertical" method="post" action="{{ route('petugasanggota.store') }}">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>{{$data->id_anggota}}</td>
                                                    ...
                                                    <td>{{$data->alamat}}</td>
                                                    <td>
                                                    <a href="{{route('petugaspeminjaman.anggota', $data->id_anggota)}}" class="btn icon icon-left btn-success"><i class="bi bi-eye"></i>
                                    Riwayat  </a>  
                                                        <button type="button" class="btn btn-outline-warning"
                                                            ...
                                                            data-bs-target="#warning-{{$data->id_anggota}}"><i
                                                                ...
                                                                <form id="delete-form-{{ $data->id_anggota }}" action="{{ route('petugasanggota.destroy', $data->id_anggota) }}"  method="POST" style="display: inline;">
                                                                    @csrf
                                                                    @method('DELETE')
                                                                    <button type="button" class="btn btn-danger" onclick="confirmDelete('{{ $data->id_anggota }}')">Delete</button>
                                                                </form>
                                                        ...
                                                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable"
                                                            ...
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <div class="card-content">
                                                                        <div class="card-body">
                                                                            <form action="{{ route('petugasanggota.update', $data->id_anggota) }}" method="POST">
                                                                                @csrf
                                                                                @method('PUT')
                                                                                <div class="form-body">
                                                                                    <div class="row">
