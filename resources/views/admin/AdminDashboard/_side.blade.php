    ...
    <div class="main-sidebar sidebar-wrapper" id="sidebar">
    <div class="sidebar-wrapper main-wrapper active">
        ...
        <div class="sidebar-menu">
            <ul class="menu">
                ...
                <li class="sidebar-item">
                    <a href="{{route('databuku')}}" class='sidebar-link'>
                ...
                <li class="sidebar-item  has-sub">
                    ...
                    <ul class="submenu ">
                        ...
                        <li class="submenu-item  ">
                            <a href="{{route('riwayat-peminjaman')}}" class="submenu-link">Peminjaman</a>

                        </li>

                        <li class="submenu-item  ">
                            <a href="{{route('riwayat-buku')}}" class="submenu-link">Data Buku</a>

                        </li>

                        <li class="submenu-item  ">
                            <a href="{{route('denda')}}" class="submenu-link">Denda</a>
                ...
                <li class="sidebar-item">
                    <a href="{{route('panduan')}}" class='sidebar-link'>
                ...
                <li class="sidebar-item">
                    <a href="{{route('instansi')}}" class='sidebar-link'>
